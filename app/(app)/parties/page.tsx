    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-600/30 flex items-center gap-2 transition-all active:scale-95 self-start md:self-auto"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* You Will Get Banner */}
        <div className="bg-gradient-to-br from-emerald-950/40 via-slate-900 to-slate-900 border border-emerald-500/30 p-5 rounded-2xl shadow-xl">
        ...
        <div className="bg-gradient-to-br from-rose-950/40 via-slate-900 to-slate-900 border border-rose-500/30 p-5 rounded-2xl shadow-xl">
          <div className="flex items-center justify-between">
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl shadow-xl flex flex-col justify-between">
          <span className="text-xs font-bold text-slate-400 uppercase">Net Khatabook Position</span>
          <div>
      ...
      {/* Parties Grid List */}
      {loading ? (
        <div className="p-12 text-center text-xs text-slate-400">Loading party directories...</div>
      ) : parties.length === 0 ? (
        <div className="p-12 text-center bg-slate-900/80 border border-slate-800 rounded-2xl text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {parties.map((party) => {
            ...
            return (
              <div
                key={party.id}
                className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col justify-between hover:border-slate-700 transition-all group"
              >
                <div>
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <span className="inline-block mt-0.5 px-2 py-0.5 rounded text-[10px] font-semibold bg-slate-800 text-slate-300 capitalize">
                        {party.partyType}
                      </span>
                    </div>
                    ...
                    {party.gstin ? (
                      ...
                      <span className="text-[10px] text-slate-500">Consumer (B2C)</span>
                    )}
                  </div>
                ...
                <div className="mt-5 pt-4 border-t border-slate-800/80 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Link
                      ...
                      className="px-3 py-1.5 rounded-lg text-xs font-bold bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 flex items-center gap-1"
                    >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handleCreateParty} className="p-5 space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-400 mb-1 font-semibold">Party Name *</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-slate-400 mb-1 font-semibold">GSTIN (Optional)</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-slate-400 mb-1 font-semibold">Billing Address</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-400 mb-1 font-semibold">Opening Udhaar Balance (₹)</label>
                  <input
                    type="number"
                    placeholder="0"
                ...
                <div>
                  <label className="block text-slate-400 mb-1 font-semibold">Balance Direction</label>
                  <select
